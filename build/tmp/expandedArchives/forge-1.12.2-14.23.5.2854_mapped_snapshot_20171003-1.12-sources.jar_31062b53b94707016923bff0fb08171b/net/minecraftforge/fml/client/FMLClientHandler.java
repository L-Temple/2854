...
//        showGuiScreen(new GuiModsMissingForServer(modMissingPacket));
    ...
    public void bindServerListData(ServerData data, ServerStatusResponse originalResponse)
    {
        ...
        else
        {
            ...
            {
                moddedClientAllowed = !serverDescription.endsWith(":NOFML¡ìr");
            }
    ...
    {
        return description.endsWith(":NOFML¡ìr") ? description.substring(0, description.length() - 8)+"¡ìr" : description;
    }
